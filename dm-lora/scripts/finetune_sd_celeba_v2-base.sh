...
data_path="/standard/dplab/fzv6en/gap/dataset/celeba/train_256_Male.zip"
...
MODEL_NAME="stabilityai/stable-diffusion-2-base" # Model card
lower_name="base-2"
...
accelerate launch train_dreambooth_lora.py \
    ...
    --instance_prompt="" \
    --validation_prompt="An image of a female face." \
...
python generate_sd_bench.py --batch_size 30 --data_name $subjects --output_dir $OUTPUT_DIR"/lora_v4_"$lower_name"_0.0005_attn2" --num_per_cls 30000 --target_size $sensitive_resolution --model_id $MODEL_NAME
