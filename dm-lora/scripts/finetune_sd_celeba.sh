...
python generate_sd_bench.py --batch_size 30 --data_name $subjects --output_dir $OUTPUT_DIR"/lora_v4_base_0.0005_attn2" --checkpoint_path $OUTPUT_DIR"/lora_v8_base_0.0005_attn2" --num_per_cls 30000 --target_size $sensitive_resolution  --model_id $MODEL_NAME
